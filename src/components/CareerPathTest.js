...
//     return (
//         <div className='w-full h-full flex justify-center items-center md:flex-row pt-20 relative'>
//             <img
//                 src={icon}
//                 alt="Brain Icon"
//                 className="opacity-70 bg-blend-overlay absolute bottom-12 left-48 hidden md:block"
//                 width={525}
//                 height={725}
//             />
//             <div className="font-robotoCondensed ml-8">
//                 <h3 className='text-2xl md:text-4xl text-white font-medium my-5'>Welcome to your</h3>
//                 <h1 className='font-adramalech text-4xl md:text-[64px] my-3'>Career Pathway Test</h1>
//                 <h4 className='md:text-2xl text-xl text-white font-medium'>Which will help you discover the top career paths based on your <br />interests and strengths.</h4>
//                 <div className=''>
//                     <div className='mt-5'>
//                         <h1 className='font-adramalech text-2xl md:text-4xl md:my-6'>Are You Ready?</h1>
//                         <button className='bg-white md:text-2xl py-2 px-5 rounded-[57px] shadow-sm shadow-white'> Get Starrted</button>
//                         <div className='flex text-white items-center md:my-8 my-1'>
//                             <span className='w-4 h-4 border-2 border-white flex justify-center items-center rounded cursor-pointer' onClick={() => setIsChecked(!isChecked)}>
//                                 {isChecked &&
//                                     (
//                                         <svg
//                                             xmlns="http://www.w3.org/2000/svg"
//                                             viewBox="0 0 24 24"
//                                             fill="none" // Set to "none" so we can apply stroke
//                                             stroke="white" // Stroke color
//                                             strokeWidth="3" // Increased stroke width to make the tick bolder
//                                             className="w-4 h-4"
//                                         >
//                                             <path
//                                                 fillRule="evenodd"
